...
png(file="G:/Github/R/Coursa program data/Explortary data/Project1/plot1.png",width=480,height=480,units='px')
with(dataTU,hist(Global_active_power,col="red",main="Global Active Power", xlab="Global Active Power (kilowatts)",ylab="Frequency"))
dev.off()